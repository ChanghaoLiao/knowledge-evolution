...
- `references/`: detailed rules loaded only for the relevant workflow.
- `assets/templates/`: reusable knowledge-base, job, and proposal templates.
- `scripts/`: read-only inspection, Import/Adopt state, deterministic batching, reconciliation-shortlist, and verification utilities.
- `tests/`: temporary-fixture integration tests for source preservation, resume, provenance, and idempotency.
